...
1、下载完整代码
2、上传到服务器
3、访问安装目录，例如你的代码放在test文件夹，则安装目录是
```
...
<br/>
<h1>交流群</h1>
如果在安装和使用期间遇到无法解决的问题，请扫码加入微信群！<br/>
