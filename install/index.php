...
<div class="container" style="width: 800px;">
  ...
  <table class="table table-bordered">
    ...
    <tbody>
      <tr>
        <td>php版本</td>
        <td>当前：<?php echo $phpv; ?>，要求php5.5~7.0 </td>
        <td>
          <?php
...
<?php
  if ($phpv >= '5.5' && $phpv <= '7.1' && file_exists("../test.txt")) {
    echo '<button type="button" onclick="install();" class="btn btn-success" id="quanju_btn_bgcolor">开始安装</button>';
    // 删除测试文件
    unlink("../test.txt");
  }
?>
