...
if(isset($_SESSION["tbktools.admin"])){
  ...
  echo '<div class="container">
    ...
    <ul class="nav nav-pills" role="tablist">
      <li class="nav-item">
        <a class="nav-link active" href="#">编辑中间页</a>
      </li>
      <li class="nav-item">
      ...
      echo '<!-- 提交 -->
      <button type="button" class="btn btn-dark" onclick="EdiZjy();">更新中间页</button>
    </form>
  ...
  function EdiZjy(){
      $.ajax({
        ...
        beforeSend:function(data){
          // 正在创建
           $(".container .Result").css('display','block');
           $(".container .Result").html('<div class="alert alert-warning"><strong>正在更新，请稍等</strong></div>');
        }
      });
  }
